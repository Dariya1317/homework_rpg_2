...
public class Orc implements Enemy{
    ...
    public Orc(String name) {
        ...
        this.speed = 20;
        this.element = "NONE";
        this.aiBehavior = "BRUTAL";
        this.abilities = new ArrayList<>();
    }

    private Orc(String name, int health, int damage, int defense, int speed, 
...
public void setName(String name) {
    ...
    public Enemy clone() {
        ...
        return new Orc(this.name, this.health, this.damage, this.defense, this.speed,
